...
function setExtendOptions() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".prodlit").off().on("click", function (item) {

        var self = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
            url: "/objavlenie/makeExtend/" + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().data("id") + "/prodlit",
            type: "POST",
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".top").off().on("click", function (item) {

        var self = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
            url: "/objavlenie/makeExtend/" + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().data("id") + "/goTop",
            type: "POST",
            data: { "_token": __WEBPACK_IMPORTED_MODULE_0_jquery___default()('meta[name="csrf-token"]').attr('content') },
            success: function success(response) {
                self.hide();
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".color").off().on("click", function (item) {

        var self = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
            url: "/objavlenie/makeExtend/" + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().data("id") + "/makePaint",
            type: "POST",
            data: { "_token": __WEBPACK_IMPORTED_MODULE_0_jquery___default()('meta[name="csrf-token"]').attr('content') },
            success: function success(response) {
                self.hide();
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".srochno").off().on("click", function (item) {

        var self = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
            url: "/objavlenie/makeExtend/" + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().data("id") + "/srochno_torg",
            type: "POST",
            data: { "_token": __WEBPACK_IMPORTED_MODULE_0_jquery___default()('meta[name="csrf-token"]').attr('content') },
            success: function success(response) {
                self.hide();
