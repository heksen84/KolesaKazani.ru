...
class ParseOlx_bytovye_uslugi extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'parse:olx_bytovye_uslugi';
...
//        "adv_coords" => "52.040616,76.926367", // Pavl, Aksu        
    ...
    array_push($dataArray, $dataBytovyeUslugi);
    ...
    public function handle() {
       ...
       $page = self::getPage("https://www.olx.kz/uslugi/bytovye-uslugi/astana/", $cookie);
...
//            return;
	    ...
	    $imgOriginalName = null;
            ...
            if ($phone != "") {                
                self::createAdvert($id, $title, $desc, null, $phone, $imgRealPath, $imgOriginalName, 0, 0, 0, 0, $optype);
            }
