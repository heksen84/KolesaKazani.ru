  ...
  <div class="container-fluid container1 mt-2" id="index_page">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 center">
      ...
      <div class="index_select_region_and_other_button_block">    
        <button class="btn btn-link" data-toggle="modal" id="locationButton" style="margin-top:-8px">Расположение {{ $locationName }} ( выбрать )</button>
        </div>
      </div>
  ...
  <div class="row text-center">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">      
      ...
      <a href="objavlenie/show/{{ $advert->id }}" class="black">
        <div class="card" style="width:220px;height:365px;margin:auto">
