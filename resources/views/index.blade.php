    ...
    <div class="center">    
      ...
      <div id="categories_title" class="shadow_text" style="margin-bottom:80px"></div>    
        ...
        <div v-show="subCategories" id="subcats">
         <button type="button" style="font-size:15px;color:grey;font-weight:bold" id="close_subcats_btn" class="btn btn-link hide" @click="returnToCategories">&#8634; назад</button>         
