      ...
      @foreach($items as $key => $item)
        <div class="row text-left">
          ...
          @if (!$item->expired)            
            ...
            <button class="btn btn-outline-primary btn-sm m-1 prodlit" title="Срок размещения объявления истёк. Вы можете бесплатно продлить объявление ещё на 30 дней"><span style="letter-spacing:1px;font-weight:400;color:red">не активно (!)</span><div style="margin-top:-3px">Продлить бесплатно на 30 дн.</div></button>
          @endif
