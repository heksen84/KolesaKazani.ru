...
<!--  <div style="float:right" class="index-side-advert mr-4 mt-2">
  ...
  <div class="container-fluid mycontainer">        
        ...
        <div class="form-group row">        
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 p-2" style="border:1px solid rgb(200,200,200);background:rgb(255,255,200)">          
            <div class="text-right"><a href="/" onclick="window.history.go(-1); return false;" class="close-link" style="position:absolute;top:8px;right:7px">X</a></div>
