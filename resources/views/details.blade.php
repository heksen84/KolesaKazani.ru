  ...
  <div class="close_button mt-1" title="Закрыть страницу" @click="closeAndReturn">X</div>
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <div id="posted"><span style="background:rgb(200,250,200);color:black;padding-right:5px;letter-spacing:1px">{{ date("Размещено d.m.Y в H:i", strtotime($advert->created_at)) }}</span></div>
