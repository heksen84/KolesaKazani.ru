...
@endif		
	...
	<div class="m-2 form-row">
		...
		<input type="number" placeholder="от" id="price_ot" class="form-control form-control-sm col-3 col-md-1 ml-1" name="price_ot" value="{{$price_ot}}" />	
		<input type="number" placeholder="до" id="price_do" class="form-control form-control-sm col-3 col-md-1 ml-1" name="price_do" value="{{$price_do}}" />	
