<template>
  <div>
    <span class="mr-9" v-if="type==='phone'">+7</span>    
    ...
    <input type="tel" :id="id" :placeholder="placeholder" :name="name" class='form-control number_input' v-model="valueInput" @input.prevent="inputHandler" :maxlength="maxlength" v-if="type==='number'" required/>
 </div>
</template>
