<template>
  ...
  <b-form-group :label="$store.state.str_realestate_area_label_text" v-if="selected.apartment && selected_type==0 || selected_type==1 || selected_type==2 || selected_type==3 || selected_type==6 || selected_type==7">
        <b-form-input type="number" v-model="input_area" class="mb-2 mr-sm-2 mb-sm-2" :formatter="changeTotalArea" style="width:160px" placeholder="Введите площадь" required></b-form-input>
  </b-form-group>
