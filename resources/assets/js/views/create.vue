<template>
	<b-container fluid>
		<b-row>
		<b-col cols="12" sm="12" md="12" lg="7" xl="7" style="text-align:left;margin:2px auto;color:black;background:white;opacity:1">
		<h3 style="color:rgb(140,140,140);margin-top:5px"><ins>новое объявление</ins></h3>
		<br>
