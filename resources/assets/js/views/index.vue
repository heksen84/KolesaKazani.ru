...
<template>
  <b-container fluid class="mycontainer">
    <b-row>
	  ...
	  <!-- BUG: допустим выбрали Астану далее перешли в недвижимость. Допустим там контроллер битый. Далее возвращаемся назад. Щёлкаем по Астане а там уже весь Казахстан вместе Астаны на кнопке -->
