<template>
	<b-container fluid class="mycontainer">		
		<b-row>
			<b-col cols="12" sm="12" md="10" lg="10" xl="10" class="result_info_col">
				<div class="close_button shadow_text" title="Закрыть страницу" @click="closeAndReturn" style="color:white;border:1px solid white;border-radius:5px;padding:5px">X</div>
	...
	<b-row v-if="filter">
			<b-col cols="12" sm="12" md="12" lg="12" xl="12" style="text-align:center">
				<b-button variant="secondary" style="margin:10px;" @click="showFilter">Применить фильтр</b-button>
			</b-col>
	</b-row>
