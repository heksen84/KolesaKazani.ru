<template>
	...
	<br>
	<b-row style="margin-top:7px" v-for="item in items" :key="item">
...
<carousel :perPage=1 :paginationEnabled="false">
  <slide>
     <b-img fluid src="https://picsum.photos/250/250/?image=54" fluid-grow alt="Fluid-Grow image" />
  </slide>
  <slide>
      <b-img fluid src="https://picsum.photos/250/250/?image=54" fluid-grow alt="Fluid-Grow image"/>
  </slide>
  ...
  <slide>
     <b-img fluid src="https://picsum.photos/250/250/?image=54" fluid-grow alt="Fluid-Grow image"/>
		...
		<b-col cols="12" sm="12" md="8" lg="8" xl="8" :key="item.id">
			<item :id="item.id" :name="item.name" :text="item.text"></item>
		</b-col>
