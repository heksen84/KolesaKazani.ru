<template>
  <b-container fluid>
    ...
    <b-row style="margin-top:2px">
        ...
        <a href="/">
          <div id="logo_block">
            <div style="font-size:170%;letter-spacing:4px;font-weight:450;padding:6px;margin-top:-8px">КупиПродай<span style="position:relative;top:-15px;left:-3px;font-size:12px;display:none">&reg</span>
            </div>
