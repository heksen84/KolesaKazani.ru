  ...
  <b-container fluid>
    ...
    <b-row>
        ...
        <b-col cols="12" sm="12" md="12" lg="6" xl="6" style="text-align:center">
          ...
          <button style="margin:3px;padding:7px;background:rgb(100,100,200);color:white;letter-spacing:2px;font-size:16px;border:1px solid white;border-radius:3px">найти</button>
        </b-col>
        <b-col cols="12" sm="12" md="12" lg="3" xl="3" style="text-align:center">
