  ...
  <b-container fluid>
    ...
    <b-row>
        <b-col cols="12" sm="12" md="12" lg="3" xl="3" style="text-align:center">
          <div id="logo_block">
            <div style="font-size:32px;letter-spacing:4px;font-weight:450;padding:2px;margin-top:-5px">велира<span style="position:relative;top:-15px;left:-3px;font-size:13px;display:none">&reg</span></div>
